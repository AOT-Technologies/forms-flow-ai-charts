...
| `externalPostgreSQLSecret.name` | Name of the existing Kubernetes secret containing the connection URI          |                                                                                |
| `externalPostgreSQLSecret.key`  | Key in the secret that contains the full database URI (e.g., `pgbouncer-uri`) |                                                                                |
