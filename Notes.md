# 🚨 Important Notice: Upgrade Impact on forms-flow-ai-charts (Helm) v8.3.2

## Key Points:

1. **Database Backup**: The latest upgrade (v8.3.2) will affect existing data. Please ensure you backup your database before proceeding with the upgrade.
